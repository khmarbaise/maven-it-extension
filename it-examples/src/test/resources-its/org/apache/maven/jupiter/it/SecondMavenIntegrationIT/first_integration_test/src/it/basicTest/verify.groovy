package org.apache.maven.jupiter.it.SecondMavenIntegrationIT.first_integration_test.src.it.basicTest
/*
...
classifierList.each { classifier ->
    def tf = new File (targetFolder, "basic-test-" + projectVersion + "-" + classifier + ".war")
