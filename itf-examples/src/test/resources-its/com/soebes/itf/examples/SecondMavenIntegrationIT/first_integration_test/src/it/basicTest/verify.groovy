package org.apache.maven.it.SecondMavenIntegrationIT.first_integration_test.src.it.basicTest
/*
...
classifierList.each { classifier ->
    def tf = new File (targetFolder, "test_project_root-test-" + projectVersion + "-" + classifier + ".war")
