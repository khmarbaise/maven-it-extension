...
image::https://github.com/khmarbaise/maven-it-extension/workflows/JDKBuilds/badge.svg[Action Status:JDK Builds]
image::https://github.com/khmarbaise/maven-it-extension/workflows/Main/badge.svg[Action Status: Main]
