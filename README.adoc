...
[.left]
image::https://img.shields.io/badge/PoC-experimental-yellow.svg[link="https://img.shields.io/badge/PoC-experimental-yellow.svg"]
--
...
Of course you can define that build should fail.
...
* Is JUnit 3 based.
* Manually https://github.com/apache/maven-integration-testing/blob/master/core-it-suite/src/test/java/org/apache/maven/it/IntegrationTestSuite.java[maintained TestSuite]
