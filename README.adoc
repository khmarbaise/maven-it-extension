...
** Conditions for execution (for example only to be executed on JDK11) and the expected result is
expressed in single separate file which in the end is a mixture of different things which violates
