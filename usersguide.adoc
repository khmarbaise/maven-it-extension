...
what does not work or does not work as described or maybe not work as you might expect it to work.
...
[source,bash]
----
mvn clean install -DskipTests -Drat.ignoreErrors=true -Dcheckstyle.skip=true
----
