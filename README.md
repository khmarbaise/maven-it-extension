...
| -------------- | --------------------------------------------------- | ----------------------------------------------------------------: | -------------------------------------------------------------: |
| 0.8.0          | [![Maven Central][shield-central]][central-search]  | [![PDF][stable-pdf-releasenotes]][releasenotes-pdf]               | [![PDF][stable-pdf-usersguide]][usersguide-pdf]                |
|                |                                                     | [![HTML][stable-html-release]][releasenotes-html]                 | [![HTML][stable-html-usersgude]][usersguide-html]              |
| 0.9.0-SNAPSHOT | ![Maven Central][not-available-in-central]          | [![PDF][unstable-pdf-releasenotes]][unstable-releasenotes-pdf]    | [![PDF][unstable-pdf-usersguide]][unstable-usersguide-pdf]     |
...
[stable-html-release]: https://img.shields.io/badge/0.8.0-HTML--Releasenotes-green
[stable-html-usersgude]: https://img.shields.io/badge/0.8.0-HTML--Usersguide-green
[stable-pdf-releasenotes]: https://img.shields.io/badge/0.8.0-PDF--Releasenotes-green
[stable-pdf-usersguide]: https://img.shields.io/badge/0.8.0-PDF--Usersguide-green

[unstable-pdf-releasenotes]: https://img.shields.io/badge/0.9.0--SNAPSHOT-PDF--Releasenotes-orange
[unstable-html-releasenotes]: https://img.shields.io/badge/0.9.0--SNAPSHOT-HTML--Releasenotes-orange
[unstable-pdf-usersguide]: https://img.shields.io/badge/0.9.0--SNAPSHOT-PDF--Usersguide-orange
[unstable-html-usersguide]: https://img.shields.io/badge/0.9.0--SNAPSHOT-HTML--Usersguide-orange
