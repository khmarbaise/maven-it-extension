...
public @interface MavenProjectSources {
  ...
  /**
   * This defines the default location where to find your project
   * setup which are used for your integration tests. If you like
   * to change the name of the location you can simply override
   * the given name.
   * <pre>
   *   src/test/resources-its/.../
   *      +--- FirstIT/
   * </pre>
   * @return The location; The default value: {@code resources-its}
   */
  String resourcesIts() default "resources-its";
