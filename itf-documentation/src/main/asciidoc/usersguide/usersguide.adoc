...
Usually you will put the integration test of your plugin within the same module where you implement
your plugin code. Sometimes it might be appropriate to separate that.
