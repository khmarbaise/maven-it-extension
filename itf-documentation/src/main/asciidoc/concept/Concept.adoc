...
https://github.com/dzikoysk/nanomaven => https://github.com/dzikoysk/reposilite
                ...
                └── it/
                    └── FirstIT/
                        └── the_first_test_case/
                            ...
                            └── pom.xml
----
This would meant that the `.pre-release-repo` contains already installed artifacts etc.
The `.pre-snapshot-repo` contains snapshots of particular artifacts.
