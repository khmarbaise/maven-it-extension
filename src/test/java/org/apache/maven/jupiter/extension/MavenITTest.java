...
class MavenITTest {
  ...
  private void beforeEach() {
    AnnotationDescription annotation = AnnotationDescription.Builder.ofType(MavenIT.class).build();
    ...
    Class<?> objectBuilder = new ByteBuddy().subclass(Object.class)
        ...
        .getLoaded();
    this.mavenITAnnotation = objectBuilder.getAnnotation(MavenIT.class);
  }
